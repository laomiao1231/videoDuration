 ...
 */
package com.m.mediax.core.utils;
...
public final class ByteUtils {
    ...
    public static byte[] wrapUInt32(long i){
        return new byte[]{
            (byte)((i >>> 24) & 0xFF),
            (byte)((i >>> 16) & 0xFF),
            (byte)((i >>>  8) & 0xFF),
    ...
    public static String read3cc(ByteBuffer bb) {
        byte[] codeBytes = new byte[3];
        bb.get(codeBytes);

        int result = ((codeBytes[0] << 16) & 0xFF0000);
        result |= ((codeBytes[1] << 8) & 0xFF00);
        result |= ((codeBytes[2]) & 0xFF);
